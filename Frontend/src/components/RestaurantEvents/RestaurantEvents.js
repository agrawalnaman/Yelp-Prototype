...
class RestaurantEvents extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://35.163.78.149:3001/getRestaurantEvents", data).then((response) => {
    ...
    submitAddEvent = (e) => {
        ...
        axios
            .post("http://35.163.78.149:3001/restaurantAddNewEvent", data)
            .then((response) => {
                ...
                if (response.status === 200) {
                    ...
                    axios.get("http://35.163.78.149:3001/getRestaurantEvents", data1).then((response) => {
                        //update the state with the response data
                        console.log(response.data);
                        this.setState({
                            addEventModal: false,
    ...
    customerListHandler = (d) => {
        ...
        axios.get("http://35.163.78.149:3001/getCustomerListEvent", data).then((response) => {
            //update the state with the response data
            console.log(response.data);
            this.setState({
